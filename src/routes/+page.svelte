...
<main class="flex flex-col h-[calc(100dvh)]">
	...
	<div class="flex flex-grow overflow-auto justify-center bg-gradient-to-b from-cee5fd to-white">
		{#if !startChat}
			<div class="flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8">
					...
					<span class="inline-block"
						...
						<span class="relative whitespace-nowrap text-slbBlue">
							<svg
								aria-hidden="true"
								viewBox="0 0 418 42"
								class="absolute top-2/3 left-0 h-[0.58em] w-full fill-slbBlue/70"
	...
	<div class=" bg-white flex justify-center items-center p-2 md:p-4">
		<div class="flex relative w-full md:w-1/2">
			<textarea
				on:input={autoResize}
				class="flex items-center justify-center py-2.5 w-full bg-gray-100 text-gray-700 border-2 border-gray-300 rounded-3xl pl-4 pr-10 focus:outline-none focus:bg-white focus:border-slbBlue resize-none"
				rows="1"
			...
			>
				...
				{#if isLoading}
					<svg
						aria-hidden="true"
						class="w-6 h-6 text-gray-200 animate-spin fill-slbBlue"
						viewBox="0 0 100 101"
						fill="none"
